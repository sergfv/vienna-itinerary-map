// Itinerary data — generated from "Carlos in Vienna, 12 to 18 June 2026" KML.
// Each day keeps its KML folder order. isBase marks the Mariahilf home base.
const TRIP = {
  title: 'Carlos in Vienna',
  subtitle: '12–18 June 2026',
  base: { lat: 48.196, lng: 16.349 },
  days: [
    {
      id: 'fri12', date: '2026-06-12', label: 'Fri 12', name: 'Fri 12 June — arrival', color: '#d64038',
      stops: [
    ...
    {
      id: 'sat13', date: '2026-06-13', label: 'Sat 13', name: 'Sat 13 June — Pride & monumental Vienna', color: '#e07b18',
      stops: [
        { name: 'Cafe Sperl', note: 'Classic coffee house, opens 07:00. Breakfast before the crowds.', lat: 48.1998326, lng: 16.3611306 },
        { name: 'Karlskirche', note: 'Baroque masterpiece — go early before the parade builds. Tip: an intimate candlelit concert here beats the big tourist ones.', lat: 48.1985626, lng: 16.3716999 },
        { name: 'Vienna State Opera', note: 'On the parade route, see it before the Ring closes to traffic.', lat: 48.2034306, lng: 16.3692034 },
        ...
        { name: 'Austrian Parliament', note: 'The parade passes here, a good spot on the Ring.', lat: 48.2080757, lng: 16.3584468 },
        { name: 'Rathausplatz, Pride Village', note: 'Heart of Pride. In 2026 the Village runs one day only, 10:00 to 22:00.', lat: 48.210821, lng: 16.3580827 },
        { name: "St. Stephen's Cathedral", note: 'Stephansplatz by night to close the day, with a lively LGBT scene around the centre.', lat: 48.2084114, lng: 16.3734707 },
      ],
    },
    {
      id: 'sun14', date: '2026-06-14', label: 'Sun 14', name: 'Sun 14 June — Schönbrunn & Kaiserbründl', color: '#5b8f1f',
      stops: [
        ...
        { name: 'Kaiserbründl', note: "Opulent historic men's sauna, opens 14:00. Your 16:00 to 19:00 window works.", lat: 48.2058275, lng: 16.374443 },
    ...
    {
      id: 'mon15', date: '2026-06-15', label: 'Mon 15', name: 'Mon 15 June — Imperial Vienna', color: '#b5338f',
      stops: [
    ...
    {
      id: 'tue16', date: '2026-06-16', label: 'Tue 16', name: 'Tue 16 June — Klimt & modernist Vienna', color: '#2e77c2',
      stops: [
    ...
    {
      id: 'wed17', date: '2026-06-17', label: 'Wed 17', name: 'Wed 17 June — secret Vienna', color: '#5f55c4',
      stops: [
        { name: 'Otto Wagner Pavillon Karlsplatz (exterior only Wed)', note: 'Museum inside opens Fri to Sun only. Admire the exterior on a Wednesday.', lat: 48.2002745, lng: 16.37032 },
        ...
        { name: 'Café Museum', note: 'A last historic coffee house — more characterful than many of the famous ones.', lat: 48.2009, lng: 16.3668, wiki: 'Café Museum' },
    ...
    {
      id: 'thu18', date: '2026-06-18', label: 'Thu 18', name: 'Thu 18 June — return', color: '#be4870',
      stops: [
...
const GALLERY = {
  ...
  "Rathausplatz, Pride Village": [
    ...
    "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Rathausturm_through_Rathauspark.jpg/500px-Rathausturm_through_Rathauspark.jpg",
  ],
